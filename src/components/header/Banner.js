  ...
  const bannerData = [
    {
      ...
      button:<a class=" banner-btn" href="#" data-text="read more"><span>About us </span> &nbsp;| &nbsp;<AiOutlineArrowRight/><span></span></a>,
    ...
    
    {
      image: '/images/advise-expert.jpg',
       caption: <h2>"Do what you do Best and</h2>,
      subhead:<h2> Outsource the Rest"</h2>,
      button:  <a class=" banner-btn" href="#" data-text="read more"><span>Our Company </span><span>|<AiOutlineArrowRight/></span></a>,
