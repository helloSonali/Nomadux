...
function Navbar() {
  return (
    <React.Fragment>
      ...
      <div className="wrapper-box">
        <div className="hidden-sidebar-close"><i className="fa fa-times" /></div>
        <div className="logo"><a href="#" title="nomadux"><img src="images/nomadux-transparente1.png" alt="logo" /></a></div>
        <div className="content">
          <div className="about-widget-two sidebar-widget">
            <h3>Your partner in Success!</h3>
            <div className="text">Nomadux has an extensive proven track record of providing the most qualified prospects to our clients in the Real Estate Investment Industry.</div>
          </div>
          <div className="contact-info">
            <h4>Contact Info</h4>                    <ul className="list-style-one">
              <li><span className="icon fa fa-location-circle"><fa className="fa fa fa-home" /></span>NOMADUX Office 901, Torres Paseo Colón, Avenida Central, San José, Costa Rica</li>                        <li><span className="icon fa fa-phone" />(516) 570-9241</li>                        <li><span className="icon fa fa-envelope" />info@nomadux.com</li>                        <li><span className="icon fa fa-clock" />Office Hrs: Today 9.00am to 5.00pm</li>                  </ul>
          </div>
        </div>
      </div>
    </section>
  ...
  </div>			<div data-elementor-type="wp-page" data-elementor-id={1517} className="elementor elementor-1517">
