             ...
             <nav className="main-menu navbar-expand-md navbar-light">
               <div className="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                 <ul  className="navigation clearfix">
                   ...
                   <li id="menu-item-2512" className="menu-item menu-item-type-custom menu-item-object-custom menu-item-2512"><NavLink title="Make a Payment" target="_blank" to="/makeapayment" className="hvr-underline-from-left1" data-scroll data-options="easing: easeOutQuart">Make a Payment</NavLink></li>
                 </ul>
               </div>
             </nav>
             {/* Main Menu End*/}
