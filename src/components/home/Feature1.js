        ...
        <div className="row">
          <div className="col-lg-4 feature-block-one wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
            <div className="inner-box">
              <div className="image">
                <div className="icon">
                  <img src="images/Untitled-1111.png" alt="img"/>
                  {/* <span class=" flaticon-customer-service"></span> */}</div>
                <img className="lazy-image owl-lazy" src="images/caller1.jpg" data-src="images/caller1.jpg" alt="Awesome Image" />
              </div>
          ...
          <div className="col-lg-4 feature-block-one wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
            <div className="inner-box">
              <div className="image">
                <div className="icon">
                  <img src="images/Untitled-2222.png" />
                  {/* <span class=" flaticon-question"></span> */}</div>
                <img className="lazy-image owl-lazy" src="images/recu.jpg" data-src="images/recu.jpg" alt="Awesome Image" />
              </div>
              <div className="content">
              <h5>Our Services</h5>
          ...
          <div className="col-lg-4 feature-block-one wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
            <div className="inner-box">
              <div className="image">
                <div className="icon">
                  <img src="images/Untitled-3333.png" />
                  {/* <span class=" flaticon-career"></span> */}</div>
                <img className="lazy-image owl-lazy" src="images/outsourcing.jpg" data-src="images/outsourcing.jpg" alt="Awesome Image" />
              </div>
              <div className="content">
                <h5>Our Services</h5>
                <h4>Outsourcing</h4>
